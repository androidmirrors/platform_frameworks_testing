 ...
 * Implementation of this interface used by {@link android.support.test.annotation.WithSetting} annotation
 * to mark a test to be run under this Device Setting.
 *
