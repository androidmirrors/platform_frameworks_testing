...
public class ActivityTestRule<T extends Activity> extends UiThreadTestRule {
    ...
    /**
     * This method can be used to retrieve the acitivity result of an activity that has called
     * setResult. Usually, the result is handled in onActivityResult of parent activity, that
     * has called startActivityForResult.
     *
