...
public class ActivityResultMatcherTest {
    ...
    private static Matcher<Intent> isSameIntent(final Intent expectedIntent) {
        ...
        return new TypeSafeMatcher<Intent>() {
            ...
            public void describeTo(Description description) {
                description.appendText("is Intent: "
                        + expectedIntent);
            }
    ...
    public void successHasResultData() {
        ...
        assertThat(ActivityResultMatchers.hasResultData(isSameIntent(intent))
                .matches(activityResult), is(true));
    }
    ...
    public void failureHasResultData() {
        Intent intent = new Intent(Intent.ACTION_MAIN);
        ActivityResult activityResult = new ActivityResult(1, intent);
        assertThat(ActivityResultMatchers.hasResultData(isSameIntent(
                new Intent(Intent.ACTION_VIEW))).matches(activityResult), is(false));
    }
