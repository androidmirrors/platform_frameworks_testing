...
public class HasBackgroundMatcherTest {
  ...
  public void verifyViewHasBackground() {
    ...
    assertTrue(HasBackgroundMatcher.hasBackground(drawable1).matches(viewWithBackground));
    assertFalse(HasBackgroundMatcher.hasBackground(drawable2).matches(viewWithBackground));
  }
  ...
  public void verifyBackgroundWhenBackgroundIsNotSet() {
    ...
    assertFalse(HasBackgroundMatcher.hasBackground(drawable1).matches(view));
  }
